...
`;let Di=class extends ce{constructor(){super(...arguments),this.selectedGameMode="",this.gameModes=[],this.selectedRegion="",this.regions=[],this.loadingTitle="",this.loadingSubtitle="",this.loadingErrorNote="",this.loadingError=!1,this.isCaptchaError=!1}tryAgain(){Pi()}render(){let e=[];for(let t=0;t<20;t++){let n=(.1*t).toFixed(2),r=this.loadingTitle.charAt(t),o=t>=this.loadingTitle.length,i=0==r.replace(/\s*/g,"").length,a=be({"animation-delay":`${n}s`,width:o?"0":null,opacity:o?"0":"1"});e.push(N`<span style=${a}
					>${Lr(i,(()=>N`&nbsp;`),(()=>N`${r}`))}</span
				>`)}return N`
		...
		`}};Di.styles=Bi,ji([fe()],Di.prototype,"selectedGameMode",void 0),ji([fe()],Di.prototype,"gameModes",void 0),ji([fe()],Di.prototype,"selectedRegion",void 0),ji([fe()],Di.prototype,"regions",void 0),ji([fe()],Di.prototype,"loadingTitle",void 0),ji([fe()],Di.prototype,"loadingSubtitle",void 0),ji([fe()],Di.prototype,"loadingErrorNote",void 0),ji([fe()],Di.prototype,"loadingError",void 0),ji([fe()],Di.prototype,"isCaptchaError",void 0),Di=ji([le("d-loading")],Di);var Ni=function(e,t,n,r){var o,i=arguments.length,a=i<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,n):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a};const Ui=s`
	#actions {
		position: absolute;
		left: 50%;
		top: calc(50% + 100px);
...
`;let Hi=class extends ce{constructor(){super(...arguments),this.spawnLevel=0,this.canViewAds=!0,this.gamemodeId="",this.completedReward=!1}firstUpdated(e){super.firstUpdated(e)}onContinue(){window.input.showMenu(),this.completedReward=!1}viewAd(){(({onreward:e,onerror:t,oncancel:n,onstart:r})=>{switch(fi){case"adinplay":{const r=document.body.querySelector(".aa.video");r.classList.add("active");const o=()=>{r.classList.remove("active")},i=e=>()=>(e&&e(),o());Ai.onreward=i(e),Ai.oncancel=i(n),Ai.onerror=i(t),Ai.ondestroy=o,aiptag.cmd.player.push((()=>{aiptag.adplayer.startVideoAd(),aiptag.adplayer.showCloseButton()}))}break;case"crazygames":window.CrazyGames.SDK.ad.requestAd("rewarded",{adFinished:()=>{Li("stats"),e()},adError:()=>{Li("stats"),t()},adStarted:()=>{}})}})({onreward:()=>{this.completedReward=!0,window.input.grantReward(),window.input.showMenu()},onerror:()=>{this.completedReward=!0,window.input.grantReward(),window.input.showMenu()},oncancel:()=>{this.completedReward=!1,window.input.showMenu()}})}render(){const e=Math.floor(1.2*this.spawnLevel)-this.spawnLevel,t=!this.canViewAds,r=this.gamemodeId;return N`
			<div id="actions">
				<d-button
					id="continue"
					.bg=${Jr(0)}
